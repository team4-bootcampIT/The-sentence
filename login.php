...
<!-- ------------------------------------------------ -->
      ...
      <a href ="socialnetworks/facebook/facebookinfo.php">  <button class="social-login" id="facebook-login">
            <span class="icon-wrapper" id="icon-wrapper-facebook">
                <i class="fa fa-facebook fa-lg" aria-hidden="true"></i>
            </span>
            <div class="social-login-text">
        ...
        <a href="socialnetworks/google/google.php"><button class="social-login" id="google-login">
